...
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/nav.css" rel="stylesheet" type="text/css" media="all"/>
...
<body>
	...
	<div class="header" id="home">
		<div class="top-header">
			<div class="container">
			<div class="logo">
				<a href="<?php echo Yii::app()->theme->baseUrl; ?>/index.html"><img src="images/logo.png" alt="" /></a>
			</div>
				...
				<!-- start search-->
					...
					<a href="<?php echo Yii::app()->theme->baseUrl; ?>/cart.html"><i class="cart"></i></a>
				</div>
			...
			<div>
              ...
              <li class="dropdown1"><a href="#">Dresses</a>
                <ul class="dropdown2">
                  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Dress Materials</a></li>
                  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Kurta & Kurti</a></li>
				  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Sarees</a>!Yii::app()->user->isGuest</li>
				  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Chudidars</a></li>
                </ul>
              </li>             
              <li class="dropdown1"><a href="#">Bags</a>
              	<ul class="dropdown2">
                  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Latest</a></li>
                  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Leather Bags</a></li>
				  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Hand Bags</a></li>
                </ul>
              </li>
           </li>           
           <li class="dropdown1"><a href="#">Shoes</a>
           	<ul class="dropdown2">
                  <li><a href=<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Sports Shoes</a></li>
                  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Casual Shoes</a></li>
				  <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">Formal Shoes</a></li>
                </ul>
           </li>        
            <li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/contact.html">Contact US</a></li>
     ...
     <!--  AQUI SE CARGAN LOS EL SIGN-IN Y  SIGN-OUT   Y EL BOTON ALL PRODUCTS -->      
            
		<div class="banner">
		<div class="signing text-right">
			<div class="container">
				<div class="sign-in">
					<a href="<?php echo Yii::app()->theme->baseUrl; ?>/signin.html">Sign In</a>
				</div>
				<div class="sign-up1">
					<a href="<?php echo Yii::app()->theme->baseUrl; ?>/signin.html">Sign Up</a>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		<div class="banner-info text-center">
				...
				<a href="<?php echo Yii::app()->theme->baseUrl; ?>/products.html">All Products</a>
		</div>
	</div>
				...
				<div class="products-section-grids">
					...
					<div class="portfolio card mix_all  data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a href="<?php echo Yii::app()->theme->baseUrl; ?>/single.html" class="b-link-stripe b-animate-go  thickbox">
